#!/usr/bin/env python3
"""
download_datasets.py — Automated dataset builder for ApniPehChaan.
...
def download_optery_brokers():
    ...
    req = urllib.request.Request(url, headers={"User-Agent": "ApniPehChaan/1.0"})
    try:
...
Generated by ApniPehChaan Agent
""",
...
if __name__ == "__main__":
    print("=" * 60)
    print("  ApniPehChaan — Dataset Builder")
    print("=" * 60)
    print()
